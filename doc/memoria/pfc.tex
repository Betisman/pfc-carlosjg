...
\usepackage{amsthm}
\usepackage{amsfonts}
% Visto en pág 14 https://books.google.es/books?id=LL22C8DRxVYC&pg=PA114&lpg=PA114&dq=quitar+tilde+de+mod+latex&source=bl&ots=4Qvf0y1UtF&sig=76uLrbeb9HZx2x7JWBIi9cBZrUw&hl=es&sa=X&ved=0ahUKEwj778m97YHUAhUBzxQKHYYJBr4Q6AEILTAB#v=onepage&q=quitar%20tilde%20de%20mod%20latex&f=false
% Si se usa el paquete babel, opción spanish, se obtendrá mód con los comandos \bmod y \pmod. El acento se puede eliminar declarando con anterioridad \unaccentedoperators
\unaccentedoperators
...
%% Reducir el tamaño de letra de las urls
\usepackage{relsize}
...
\newpage
\input{anexoConfiguracionServidorWebOauth.tex}
