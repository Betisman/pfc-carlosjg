...
\todo[inline]{Carlos, asegúrate de que comentamos en algún sitio que es el primer sistema con el que se puede votar con el nuevo DNIe 3.0. Importante por la novedad.}
	...
	Este proyecto representa una prueba de concepto de cómo se puede implementar un sistema de voto por Internet que permita que el DNIe 3.0 sea la herramienta que permita la identificación digital del votante y que el acceso al sistema de voto se pueda realizar desde dispositivos móviles tales como un smartphone o una tablet Android.
