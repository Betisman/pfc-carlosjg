...
Hay que modificar el fichero \textit{reset.sh}. Hay que sustituir la línea
\begin{verbatim}
...
\todo[inline]{Hay que arreglar que no se corten las líneas al ser tan largas. En un documento he visto algo de usar el paquete spverbatim}
