...
% *************************************************************************************************************** %
	\section{ggggggggggggggggggggg}
		...
		\notasCambio[inline]{Introducir la firma del voto con el DNIe no introduce ingún tipo de mejora en la seguridad respecto del que provee de por sí la propia herramienta Helios Voting. Así que no lo vamos a hacer. Hay que cambiar las modificaciones sobre la msima.}
