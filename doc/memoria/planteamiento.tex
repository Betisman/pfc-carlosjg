	...
	\begin{center}
		\fbox{
			\begin{minipage}{0.8\textwidth}
				Diseñar un esquema y un sistema de voto electrónico remoto a través de Internet que sea robusto, fiable, verificable y auditable para que se puedan llevar a cabo las Elecciones a Miembro de la Junta Electoral de la Escuela Politécnica Superior de la Universidad San Pablo CEU.
			\end{minipage}
		}
	\end{center}
