...
En el caso de las Elecciones a la Junta de Escuela de la EPS CEU, la identificación de los votantes...
				...
				\begin{itemize}
					\item Usuario / contraseña.
						...
						\par
						Esta solución, no obstante, sería inviable para elecciones más ambiciosas, como lo son las legislativas estatates o autonómicas, ya que carecemos de elementos como direcciones de correo electrónico de todo el censo.
