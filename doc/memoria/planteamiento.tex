...
% *************************************************************************************************************** %
	\section{ggggggggggggggggggggg}
		...
		\subsection{Diagrama Entidad-Relación}\label{helios_diagrama_er}
			...
			A continuación se muestra el diagrama entidad-relación del sistema Helios Voting real. Se ha obtenido con una herramienta, SchemaSpy\footnote{http://schemaspy.sourceforge.net/}, que permite obtener el diagrama directamente de una base de datos PostgreSQL ya existente.
