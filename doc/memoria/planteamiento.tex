...
\begin{itemize}
	...
	\begin{description}
		\item[Elaboración del censo]: Las autoridades de la Elección deben realizar un proceso de elaboriación del censo electoral, para identificar qué votantes tienen derecho a ejercer el voto y dónde (con qué opciones de vooto).
