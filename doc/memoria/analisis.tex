...
pantallas a las que tienen acceso los diferentes roles de usuario y la conexión entre éstas. }
	...
	\section{Esquema de Voto Electrónico}\label{analisisEsquemaVotoElectronico}
		...
		Algo en lo que se desenvuelve muy bien el homomorfismo es en la totalización, por lo que es una gran herramienta para un sistema de voto. Un protocolo que es capaz de totalizar votos cifrado sin necesidad de descifrarlos es una gran opción para mantener el secreto del voto. Por otro lado, no es la mejor solución para la confianza en el sistema. Para paliar este problema de confianza es donde aparecen las pruebas de conocimiento cero. Gracias a pruebas criptográficas se puede asegurar que tanto votos como la suma de ellos no han sido manipulados y fueron correctamente cifrados.
