...
% *************************************************************************************************************** %
	...
	\section{Integración}\label{analisis_integracion}
		...
		\subsection{Sistema central de votación}\label{analisis_integracion_sistemaVotacion}
			...
			\begin{table}[htbp]
				...
				\begin{threeparttable}
    				...
    				\hline
    				\textbf{Software Libre} & Helios Voting es un proyecto de Software Libre, lo que permite que pueda ser modificado, lo cual es ideal para utilizarlo como base de un sistema integrado, adaptándolo a las necesidades propias de nuestro desarrollo. \\
    				\hline
		...
		\subsection{Cliente web + app Android}
			...
			La Policía ha puesto a disposición de los desarrolladores tres aplicaciones de Android como ejemplo de cómo se pueden acceder a los certificados a través de estos dispositivos por \gls{NFC}.
...
% *************************************************************************************************************** %
	\section{Helios Voting}\label{planteamiento_HeliosVoting}
		...
		Tras el estudio de diferentes opciones para la implementación del \textit{core} del sistema de votación, se ha decidido, teniendo en cuenta en los motivos planteados en \ref{analisis_integracion_sistemaVotacion}, basar el desarrollo de este módulo en la adaptación del proyecto de software libre Helios Voting.
