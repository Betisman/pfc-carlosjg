...
Una vez ha sido presentado el proyecto, planteados los objetivos y estudiado el estado de la cuestión, la siguiente fase en el desarrollo es el Análisis. En esta etapa se analiza el problema con el cliente, llegando a un acuerdo en el alcance del proyecto y los requisitos que deben ser satisfechos.
		...
		% ------------------------------------------------------------------
			...
			\todo[inline]{AQUÍ HAY QUE DEFINIR LOS REQUISITOS DEL VOTO ELECTRÓNICO. DEPENDE DEL AUTOR, HAY UNOS U OTROS. HABRÁ QUE DEFINIR CUÁLES SON LOS QUE VAMOS A TENER EN CUENTA PARA ESTE PROYECTO. ESTÁN EN --TEMP-- ESPERANDO A QUE TOME LA DECISIÓN}
			...
			\begin{description}[font=$\bullet$\ \ ]
			%% ESTE NO CREO QUE DEBA IR, YA	QUE ES UN RESUMEN DE LOS SIGUIENTES
			...
			\todo[inline]{OTRA FORMA EN LA QUE PODEMOS ORDENAR LA ESPECIFICACIÓN DE REQUISITOS  HAY QUE RE-REDACTARLO}
		...
		% ------------------------------------------------------------------
			...
			\section{Roles / Actores}\label{actores}
				...
				\begin{description}[font=$\bullet$\ \ ]
					...
					\notasCambio{CAMBIAR EL NOMBRE a miembro de la Junta Electoral}
