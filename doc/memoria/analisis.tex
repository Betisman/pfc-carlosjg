		...
		% ------------------------------------------------------------------
			\subsection{Introducción}\label{requisitosIntroduccion}
				...
				\begin{description}[font=$\bullet$\ \ ]
					...
					\item[Organizacionales]: *************** \notasInfo{yo esto lo considero de otra forma ..., según wikipedia: son el marco contextual en el cual se implantará el sistema para conseguir un objetivo macro }
				\end{description}
