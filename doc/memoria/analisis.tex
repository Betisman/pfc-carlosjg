...
% *************************************************************************************************************** %
	...
	\section{Integración}\label{analisis_integracion}
		...
		Tras un estudio de posibilidades y alternativas, se ha decidido implementar el sistema en base a tres módulos integrados:
		\begin{itemize}
			\item Servidor central de votación => \textbf{Helios Voting}
			\item Servidor de autenticación / identificación de usuario => \textbf{oAuth 2.0 Server}
			\item Cliente web + app Android => \textbf{Web / App Android Policía}
		\end{itemize}
