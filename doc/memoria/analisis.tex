...
% *************************************************************************************************************** %
	...
	o----------- \todo[inline]{Hay que revisar cómo redactar correctamente este apartado}
	
	
	
			La primera idea para integrar el \gls{DNIe} en el sistema Helios consistía en realizar un acceso seguro, por \gls{SSL}, que requiriese autenticación por el \gls{DNIe}, del mismo modo que la mayoría de las webs de la Administración pública.			
			...
			---- \todo[inline]{Este apartado debe ser mejorado}	
		...
		\subsection{Adaptación a dispositivos}\label{analisis_adaptacion_dispositivos}
			...
			\todo[inline]{Continuar con la migración a responsive web}
		...
		\subsection{Votación}\label{analisis_votacion}
			...
			La posibilidad de permitir al votante emitir su voto más de una vez proviene, en parte, de la necesidad de proteger al votante frente a la cocacción por parte de un tercero.
