			...
			\subsection{Esquemas de Voto Electrónico}\label{esquemasVotoElectonico}
				...
				\begin{itemize}
					...
					\item Esquema de Voto Electrónico basado en Firma Ciega
						En un Esquema de Firma Ciega, el firmante no conoce el contenido del mensaje que firma, ya que el emisor del mismo realiza un proceso previo para ocultar el mismo, lo que se conoce por \textit{cegar} el mensaje.
				\end{itemize}
