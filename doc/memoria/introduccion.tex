\chapter{Introducción}
	...
	***************** UN POQUITO MÁS DE HISTORIA ******* HABLAR DE DRE Y TARJETAS PERFORADAS *****************
	...
	\section{Estado de la cuestión}\label{estadoCuestion}
		...
		Cuando se habla de voto electrónico, una primera acepción del término se refiere a los procesos electorales cuyas fases pueden llevarse a cabo haciendo uso de tecnologías de la información. Dentro de estas fases susceptibles de ser implementadas con protocolos informáticos se incluyen el registro de votantes, diseño de mapas de distritos o circunscripciones electorales, y la gestión, administración y logísitca electoral; así como el escrutinio provisional o definitivo, transmisión de resultados y difusión de los mismos, o el sufragio del voto en sí mismo.
		
		No obstante, una definición más simple del voto electrónico se refiere úniacamente a este último acto de votar, ya sea a través internet o simplemente utilizando sistemas que no estén intercomunicados a través de internet, aunque sí con un servidor receptor del voto.
...
%							\textbf{Elección} & \textbf{Tipo} & \textbf{Votantes por internet} & \textbf{\% sobre total votantes} \\
			...
			******** ME HE QUEDADO POR AQUÍ *******
			...
			\subsubsection{SEVI}\label{sevi}
				El Sistema Electrónico de Votación por Internet (SEVI) \cite{tesisMLLGarcia} es una propuesta de sistema software de voto electrónico para reemplazar el canal que constituye el correo postal certficado en el proceso electoral de México.
		...
		\subsection{Voto por internet en la EPS}
			...
			\subsection{Primitivas de criptografía}\label{primitivasCriptografia}
				...
				*********************************************
				...
				\begin{description}
					\item[Primitivas] Operaciones matemáticas, usadas como bloques constructores en la realización de esquemas. Su caracterización depende de los problemas matemátivos que sustentan su uso criptográfico. Ej: DES, RSA.
				...
				*********************************************
					...
					\subsubsection{Firma ciega}\label{primitivaFirmaCiega}
						...
						El objetivo de este tipo de protocolos es proporcionar una serie de datos frimados cuyo contenido solamente sea conocido por el actor que envía, siendo completamente desconocidos para el actor que los firma.\\
					...
					\subsubsection{Secreto compartido}\label{primitivaSecretoCompartido}
						Los protocolos criptográficos de secreto compartido dividen un mensaje (secreto) determinado en diferentes fragmentos que se reparten entre los participantes de la comunicacion.
