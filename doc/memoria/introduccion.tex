			...
			\subsection{Esquemas de Voto Electrónico}\label{esquemasVotoElectronico}
				...
				\begin{itemize}
					...
					\item Esquema de Voto Electrónico basado en Mixnets
						...
						******************* LITERAL ******** La principal crítica a este esquema es que las pruebas de correctitud son voluminosas. Existen algunas implementaciones comerciales de sistemas de wlwcción electrónica basadas en este esquema.
