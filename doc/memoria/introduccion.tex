				...
				\begin{itemize}
					...
					\item Esquema de Voto Electrónico basado en Firma Ciega
						...
						********* Explicación del proceso (Chaum??) **************
						...
						Podemos encontrar este esquema en soluciones como la propuesta en 1992 por Fujioka en \ref{Fujioka93}, la cual sirvió de base a Cranor para la implementación de un prototipo (Sensus).\\
