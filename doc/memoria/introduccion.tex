\chapter{Introducción}
	...
	***************** UN POQUITO MÁS DE HISTORIA ******* HABLAR DE DRE Y TARJETAS PERFORADAS *****************
	...
	En este caso, las empresas adjudicatarias implementan soluciones tecnológicas para llevar a cabo el proceso. Así, se puede destacar la tecnología electoral de empresas como Indra \cite{indraPPEE} - pionera en uso de tablets para enviar información de recuento o la Mesa Administrada Electrónicamente que agiliza y da soporte a la labor de los miembros de mesa, desde gestión del censo a generación de actas de escrutinio - o Scytel \cite{scytel1}, referente a nivel mundial en proyectos de voto electrónico, tanto presencial como remoto.
...
Hasta aquí están las características inherentes a un sistema de votación tradicional, el realizado hasta ahora en cualquier proceso electoral que haya habido en España, por ejemplo. A conrinuación, añaden una serie de propiedades ligadas a las propuestas por Fujioka en cuando al voto electrónico:
				\begin{description}
			...
			\subsection{Primitivas de criptografía}\label{primitivasCriptografia}
				...
				*********************************************
				...
				\begin{description}
					...
					\item[Protocolos] Secuencias de operaciones, a realizar por dos o más entidades,que contienen esquemas y primiticas con el propósito de dotar a una aplicación de características de seguridad. Ej: TLS con %TLS_RSA_WITH_DES_CBC_SHA
				\end{description}
				*********************************************
					...
					\subsubsection{Pruebas de conocimiento nulo}\label{primitivaPruebasConocimientoNulo}
						...
						Uno de los mejores y más sencillos ejemplos para entender el concepto de este tipo de protocolos lo encontramos en una publicación de Pablo Della Paolera, astrónomo de la Universidad Nacional de La Plata (Argentina), en su blog personal \cite{dellaPaolera2014}. En ella explica que se puede demostrar que se enuncia algo correctamente sin necesidad de demostrar por qué.
