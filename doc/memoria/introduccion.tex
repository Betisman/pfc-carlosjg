\chapter{Introducción}
	...
	\section{Análisis del sistema real}\label{analisisSistemaReal}
		...
		\subsection{Elecciones de delegados de curso en la EPS}\label{analisisDelegadosEPS}
	...
	\section{Metodología}\label{metodologia}
		...
		Para la redacción del documento del PFC se hizo uso de \LaTeX, a través del IDE 