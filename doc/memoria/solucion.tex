...
\end{verbatim}
					...
					\item[Aplicación de autenticación]
						...
						La aplicación recibe del servidor web la información del certificado del cliente a través de los METAS inyectados en el header de la request por parte del servidor.
