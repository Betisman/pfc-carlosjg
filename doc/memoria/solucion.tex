...
\end{lstlisting}
			...
			\todo[inline]{Diagrama sistema votación}
...
\end{lstlisting}
		...
		\end{description}
			...
			\todo[inline]{Faltan un par de párrafos}
...
\todo[inline]{IMPORTANTE!!!!!!!!!!!!!!!!!!!!!}
			...
			\section{Diseño de la interfaz de usuario}\label{diseño_interfaz_usuario}
				...
				\subsection{Accesibilidad}
					...
					\begin{description}
						\item [WCAG 2.0] El diseño de la web ha sido modificado para cumplir con el máximo de pautas posibles marcadas en el estándar de accesibilidad \gls{WCAG}2.0\footnote{\url{http://www.sidar.org/traducciones/wcag20/es/}} propuesto por el consorcio \gls{W3C}.
