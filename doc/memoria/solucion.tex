...
%*
	...
	%\end{figure}
		...
		\section{Diseño}\label{diseño}
			...
			Tal como se determina en el análisis (\ref{analisis}), la solución que se propone para este Proyecto consiste en la adpatación del sistema Helios Voting a las necesidades de la EPS.
			
			Es preciso modificar el sistema de autenticación de Helios Voting para dar soporte al DNIe 2.0 y al 3.0. Para ello se integrará un sistema de autenticación federada por oAuth. Este sistema, no obstante, tendrá que ser modificado para que soporte la información digital de estos documentos. 
