...
%*
	...
	%\end{figure}
		...
		\section{Diseño}\label{diseño}
			...
			Tal como se determina en el análisis (\ref{analisis}), la solución que se propone para este Proyecto consiste en la integración de tres soluciones, adptándolas a las necesidades de una elección para la EPS.
...
<resources xmlns:android="http://schemas.android.com/apk/res/android">
  <array name="trusted_hosts">
    ...
    <!-- En el servidor: openssl x509 -fingerprint -noout -in server.crt -->
				...
				\subsubsection{Definición de la papeleta}\label{solucion_definicionPapeleta}
			...
			\subsection{Topología de la red}
				...
				\begin{enumerate}
					\item Servidor de autenticación y Servidor de votación en la misma red. Acceso de los votantes desde Internet. Figura \ref{fig:topologiaRed_servidoresMismaRed}
						...
						\item Servidor de autenticación y Servidor de Votación en redes diferentes. Acceso de los votantes desde Internet. Figura \ref{fig:topologiaRed_servidoresDistintaRed}
						...
						\item Tanto el Servidor de autenticación, como el Servidor de Votación y los dispositivos se comunican por la misma red, sin necesitar acceder a través de Internet. Figura \ref{fig:topologiaRed_intranet}
						...
						\begin{figure}[htbp]
							...
							\caption{Topología de la red con los servidores y los dispositivos en intranet.}
			...
			\subsection{Diseño de la interfaz de usuario}\label{diseño_interfaz_usuario}
				...
				\iffalse
				Con respecto a la accesibilidad, los mayores cambios realizados en la web han sido:
				
				- Cambio de colores para cumplir con el contraste suficiente propuesto.
				\fi
