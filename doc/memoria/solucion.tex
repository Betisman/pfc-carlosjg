								...
								\end{center}
								 ...
								 \end{center}
									...
									\end{center}
									 \\
							\hline
							\multirow{4}{*}{Servidor Identificaión} 	& 8662 & 192.168.1.144 & 442 	& Puerto de acceso al servidor Apache por HTTPS/TLS \\
							\cline{2-5}
																												& 8888 & 192.168.1.144 & 80 	& Acceso al Apache por HTTP sin seguridad \\
							\cline{2-5}
																												& 8443 & 192.168.1.144 & 443 	& Puerto de acceso al servidor Apache por HTTPS/TLS \\
							\cline{2-5}
																												& 8022 & 192.168.1.144 & 22 	& Acceso SSH \\
							\hline
		          \multirow{4}{*}{Servidor Votación}	 			& 8889 & 192.168.1.145 & 80 	& Acceso al Apache por HTTP sin seguridad \\
							\cline{2-5}
		          																					& 8445 & 192.168.1.145 & 443 	& Puerto de acceso al servidor Apache por HTTPS/TLS \\
							\cline{2-5}
