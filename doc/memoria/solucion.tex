	...
	\section{Prototipo}\label{solucion_prototipo}
		...
		\subsection{Arquitectura física}\label{solucion_prototipo_arquitecturaFisica}
			...
			\begin{figure}
		    		...
		    		\begin{minipage}{0.45\textwidth}
		        		\centering
					\includegraphics[width=0.80\textwidth]{imgs/prototipoRaspberryPi01}
		    		...
		    		\begin{minipage}{0.45\textwidth}
			        	\centering
					\includegraphics[width=0.90\textwidth]{imgs/prototipoRaspberryPi02}
		...
		\begin{figure}[!htbp]
			\centering
				\includegraphics[width=.45\textwidth]{imgs/prototipoRouterTPLINK}
