...
\end{lstlisting}
			...
			\section{Sistema de votación}\label{arquitectura_servidorVotacion}
				...
				\begin{figure}[!ht]
					\centering
						\includegraphics[width=.95\textwidth]{imgs/arquitecturaSistema.png}
...
\end{lstlisting}
		...
		\end{description}
			...
			El flujo del proceso de identificación del usuario a través del protocolo oAuth2 modificado se puede observar en la figura \ref{fig:flujo.oauth}, donde se esquematizan los siguientes pasos:
					...
					\end{figure}
					\todo[inline]{Arreglar el diagrama \ref{fig:flujo.oauth}}
...
\end{lstlisting}
	...
	Sin embargo, cuando hay más trustees, una vez el sistema descifra su parte, avisa al resto de trustees de que deben descifrar su parte con su clave y queda a la espera de que esto ocurra.
				...
				\todo[inline]{Capturas de pantalla}
...
%\fi		
	...
	\section{Prototipo}\label{solucion_prototipo}
		...
		El router utilizado para el prototipo ligero ha sido un TP-LINK TL-WR702N (fig. \ref{fig:prototipo.router.tplink}). Se trata de un modelo de router muy simple y ultraportable, con lo que se manifiesta la facilidad de puesta en producción de una elección a pequeña escala que resulte asequible económicamente.
