				...
				\subsection{Votación}
					...
					\begin{description}
						...
						\item [Paso 1. Selección de candidatos] \hfill \
							...
							Dependiendo de la configuración de la elección y de cada una de las preguntas, el votante podrá no elegir ningún candidato, elegir sólo 1, un rango o abstenerse.
