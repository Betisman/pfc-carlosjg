...
<resources xmlns:android="http://schemas.android.com/apk/res/android">
  <array name="trusted_hosts">
    ...
    <!-- En el servidor: openssl x509 -fingerprint -noout -in server.crt -->
					...
					Una vez asumimos el certificado autofirmado, por din accedemos a la web del sistema de voto logados con la información contenida en el {certificado de autenticación de nuestro DNIe 3.0 (figura \ref{fig:login.android.logado}).
