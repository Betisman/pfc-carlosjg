			...
			\subsection{Estructura}
				...
				\begin{description}
					...
					\item [Autenticación]
						...
						Lo más peculiar de este subsistema es que contiene adaptadaores par los diferentes sistemas de login que expone. Dentro de la carpeta \textit{auth\_system} implementa una serie de módulos que gestionan estos diferentes métodos de login.
						...
						Además, incluye un módulo \textit{password.py} utilizado para la identificación de usuario por medio de usuario / contraseña.
