...
\footnotetext[\value{epihc}]{Presidente del Gobierno de España (1976-1981) \url{https://es.wikipedia.org/wiki/Adolfo_Su\%C3\%A1rez}}
	...
	% *************************************************************************************************************** %
		...
		\subsection{Niveles}\label{votoElectronicoNiveles}
			...
			\begin{itemize}
				\item[$\bigodot$] Nivel 0
				\item[$\bigodot$] Voto electrónico sustitutivo
				\item[$\bigodot$] Voto electrónico remoto
				\begin{itemize}
...
%}
			...
			\subsection{Universidades}\label{iVotingUniversidades}
				A nivel de Juntas de Gobierno o de Elecciones de Rector a nivel universitario, merece la pena introducir que existen experiencias de voto por Internet en varias de ellas, destacando las de la \gls{UNED} o las de la \gls{UPV/EHU}.
					...
					\begin{enumerate}
						\item Preparación. Preparar las necesidades a cubrir del resto de fases.
						\item Fase Preelectoral. En esta fase, se precarga el sistema con el censo de la elección, los parámetros que la definen y se generan las claves de cifrado de los votos.
						\item Votación. Fase en la que el votante introduce su voto en el sistema y éste lo guarda cifrado.
						\item Recuento. Se desencriptan los votos para ser contados. A continuación, se publican los resultados.
					\end{enumerate}
