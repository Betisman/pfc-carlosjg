...
%\notasDuda{TLS_RSA_WITH_DES_CBC_SHA}
			...
			\subsection{Primitivas criptográficas}\label{primitivasCriptografia}
				...
				\todo[inline]{esto no es una subsection!!!!}
...
\fi				
	...
	\section{Estado actual de las tecnologías}
		...
		\subsection{NFC}\label{estadoNFC}
			...
			%\notasInfo[inline]{hjhjhjh \url{http://www.feedspot.com/?dadi=1#feed/fof_fo_353622__f_38903/article/3511839278?dd=43115052604544} }
			%\notasInfo[inline]{fgfg \url{https://mundonfc.wordpress.com/2012/02/09/como-funciona-el-nfc/}}
			NFC (\textbf{N}ear \textbf{F}ield \textbf{C}ommunication - Comunicación de Campo Cercano) se trata de una tecnología de comunicación inalámbrica de corto alcance.
			...
			\begin{figure}[htbp]
				...
				\caption{Arquitectura de un chip NFC}
			...
			\begin{description}
				...
				\item[Modo emulación NFC Card] Este modo permite al dispositivo actuar como una Smartcard estándar, es decir, la transmisión de datos se encuentra securizada.
			...
			Ya en 2015, con la salida del \gls{DNIe} 3.0, la tecnología NFC llegó a la identificación de los ciudadanos españoles. Esta nueva versión del carnet de identidad complementa el chip con contacto que incluía la primera versión del \gls{DNIe} con un chip sin contacto que realiza las mismas funciones sin necesidad de un lector de chips del primer tipo.
...
para el certificado de la CA raíz.
				...
				\item Realizar la validación OCSP contra el servidor de la FNMT.
			\end{itemize}
