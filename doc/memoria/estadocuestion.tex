...
%\notasDuda{TLS_RSA_WITH_DES_CBC_SHA}
			...
			\section{Esquemas de Voto Electrónico}\label{esquemasVotoElectronico}
				...
				El propio autor de la tesis citada \cite{tesisSeguridadVMMorales}, incorpora (en la página 109) un resumen con las ventajas y desventajas que ofrece cada uno de estos esquemas:
				
				\begin{table}[htbp]
					\fontsize{10}{9}\selectfont
					\begin{tabularx}{\textwidth}{|M|Y|Y|}
						\hline
							\centering\textbf{Clasificación} & \textbf{Ventajas} & \textbf{Desventajas} \\
						\hline
