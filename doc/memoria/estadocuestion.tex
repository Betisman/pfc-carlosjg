...
%\notasDuda{TLS_RSA_WITH_DES_CBC_SHA}
			...
			\todo[inline]{El problema es que parece que repetimos en los esquemas lo que se pon en las primitivas. Hay que ver cómo debo escribirlo.}
				...
				Aprovrchando que en el último esquema se cita la tesis de Morales Rocha \cite{tesisSeguridadVMMorales}, vamos a introducir una alternativa en cuanto al tipo de esquemas de voto electrónico existentes. En esta tesis, el autor define cuatro grupos de esquemas de voto electrónico remoto. Estos se diferencian en la forma en la que usan los elementos criptográficos para tratar de resolver los requisitos de seguridad de un sistema electoral:
				\begin{itemize}
