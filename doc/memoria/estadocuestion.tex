...
\footnotetext[\value{epihc}]{{Del discurso de cierre de campaña. 14 de junio de 1977}
\setcounter{epihc}{\value{footnote}}\stepcounter{epihc}
\footnotetext[\value{epihc}]{Presidente del Gobierno de España (1976-1981)  los Estados Unidos de América (1963-1969) \url{https://es.wikipedia.org/wiki/Adolfo_Su\%C3\%A1rez}}}
		...
		\section{Proyectos de Sistemas de Votación Auditables Punto a Punto}\label{estadocuestion_e2everifiability}
			...
			De los tres 
				...
				\subsection{ADDER}\label{estadocuestion_adder}
					...
					\begin{figure}[h]
						\centering
							\includegraphics[width=\textwidth]{imgs/ADDER_diagrama.jpg}
