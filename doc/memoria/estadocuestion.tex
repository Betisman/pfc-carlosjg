			...
			\begin{center}
				...
				\end{center}
					...
					\subsubsection{Cifrado homomórfico}\label{primitivaCifradoHomomorfico}
						...
						Definamos $\delta$ como la función de descifrado y $\varepsilon$ como la función de cifrado.
						
					    $\delta(\varepsilon(m, k), k) = m$
					    
					    $\delta(f(\varepsilon(m, k)), k) = g(m)$
						...
						$ f(m) = m[0] * m[1] \Rightarrow $
						
						$ f(m) = 11 * 7 = 77 $
						
						$ \varepsilon(m, k) = m' $
						
						$ \varepsilon(11|7, k) = [15, 12] = m' $
						...
						\begin{description}
							\item [RSA] $\varepsilon(m_1) * \varepsilon(m_2) = \varepsilon(m_1 * m_2)$
							\item [ElGamal] $\varepsilon(m_1) * \varepsilon(m_2) = \varepsilon(m_1 * m_2)$
							\item [Benaloh] $\varepsilon(m_1) * \varepsilon(m_2) = \varepsilon(m_1 + m_2 mod c)$
							\item [Goldwasser-Micali] $\varepsilon(x_1) * \varepsilon(x_2) = \varepsilon(x_1 \oplus x_2)$
							\item [Paillier] $\varepsilon(m_1) * \varepsilon(m_2) = \varepsilon((m_1 + m_2) mod c)$
						\end{description}
						...
						\paragraph{ElGamal / ElGamal Exponencial}\label{primitivaCifradoHomomorfico_elgamal}
