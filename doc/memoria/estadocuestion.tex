	...
	\section{Estado actual de las tecnologías}
		...
		\subsection{DNIe}\label{estadoDNIe}
			...
			\hline
					...
					\end{tablenotes}
					\caption{Comparativa DNIe - DNIe 3.0.\label{tab:DetallesTecnicosRaspberryPi}}
				\end{threeparttable}
			\end{table}
			...
			\todo[inline]{Del documento \url{https://www.incibe.es/extfrontinteco/img/File/intecocert/dnie/pdf/guiades.pdf}}
			El proceso a seguir cuando se está en posesión todos los certificados necesarios para operar con el \gls{DNIe} es (para cada uno de los certificados):
			\begin{itemize}
