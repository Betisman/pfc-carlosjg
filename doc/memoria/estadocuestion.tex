...
Basándonos en el ejemplo publicado, supongamos dos actores $Manuel$ y $Carmen$. 
						...
						$Carmen$ quiere demostrar que \textit{$Manuel$ tiene (o no) la misma cantidad de monedas en su bolsillo izquierdo que en el derecho}. \\
						
						Para ello, la forma más simple de hacerlo sería que $Carmen$ le pidiese a $Manuel$ las monedas de cada bolsillo y las contase. Por tanto, para demostrar la afirmación de que \textit{$Manuel$ realmente tiene (o no) las mismas monedas en cada bolsillo} basta con que las enseñe. \\
