...
Voting systems are hard to make trustworthy because they have strong, conflicting security requirements:
	...
	\url{https://www.cs.cornell.edu/projects/civitas/papers/clarkson_civitas_tr.pdf}
				...
				\begin{description}[font=$\bullet$\ \ ]
					...
					\item[Incoercebilidad (Incoercibility)]: El votente no puede ser coercido por un tercero para que vote por una opción en concreto. Se debe asegurar la libertad del voto. 
...
%\notasDuda{TLS_RSA_WITH_DES_CBC_SHA}
	...
	\section{Estado actual de las tecnologías}
		...
		\subsection{Web}\label{estado_web}
			\notasInfo{La web no está preparada para certificados personales, etc, etc...}
