...
los diálogos del sistema.
				...
				Para ello, se han recogido las de una Universidad española puntera en proyectos de software libre como es la Universidad de Extremadura, para poner en esta memoria un ejemplo de este país. Y se ha incluido un artículo holandés por ser el más interesante de los más recientes publicados, intentando dar una definición de vanguardia.
