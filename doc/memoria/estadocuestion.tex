				...
				\end{center}
					...
					\subsubsection{Cifrado homomórfico}\label{primitivaCifradoHomomorfico}
						...
						\paragraph{ElGamal}\label{primitivaCifradoHomomorfico_elgamal}
							...
							Clave: \hfill \\
							El algoritmo de ElGamal necesita un par de claves pública - privada para poder ser utilizado. Para ello, el cifrador del mensaje ha de escoger tres números:
							\begin{itemize}
						...
						\hfill \\
							...
							y modifiquemos la función ref-a-la-funcion de modo que
