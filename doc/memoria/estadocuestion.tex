...
\notasCambio[inline]{ 
Voting systems are hard to make trustworthy because they have strong, conflicting security requirements:
	...
	\url{https://www.cs.cornell.edu/projects/civitas/papers/clarkson_civitas_tr.pdf}
}
				% *************************************************************************************************************** %
...
%							\textbf{Elección} & \textbf{Tipo} & \textbf{Votantes por internet} & \textbf{\% sobre total votantes} \\
				...
				\begin{flushleft}
					...
					\caption*{\textbf{\%tv}: \% de votantes que votaron a través de Internet sobre el total de votantes.}			
				\end{flushleft}
...
%Desde el año 2005, Estonia se ha apoyado con éxito en Internet para realizar siete elecciones gubernamentales. Como evidencia del nivel de confianza pública en el sistema, en las elecciones al Parlamento Europeo ocurridas en mayo de este año el 33\% de todo el electorado estonio decidió emitir su voto en línea.
		...
		\notasCambio[inline]{Destacar que estas tablas vienen de una ponencia de Justo Carracedo, presentación en Posibilidades del voto telemático en la democracia digital \url{http://www.criptored.upm.es/descarga/ConferenciaJustoCarracedoTASSI2014.pdf}}
			...
			\subsection{Civitas}\label{civitas}
				\todo[inline]{http://www.cs.cornell.edu/projects/civitas/}
			...
			Para cumplir el requisito de la verificabilidad individual, el sistema estonio se apoya en una app para smartphones que gestiona la verificación del voto, mientras que en la solución noruega apuestan por una sistema de retorno de código por SMS. A través de ambos protocolos, se permite al votante una herramienta a través de la cual puede asegurarse de que su voto ha sido correctamente incluído en la votación.
			Los problemas para cumplir con los requisitos de Benaloh aparecen cuando se estudian las herramientas para cumplir con la verificabilidad universal. El método tradicional para garantizar este requisito es utilizar las pruebas de conocimiento zero (\ref{primitivaPruebasConocimientoNulo},\ref{zeroKnowledgeProof}). Con estas pruebas se trata de convencer a un verificador de que el proceso se ha llevado a cabo correctamente con una alta probabilidad, sin necesidad de que el verificador tenga conocimiento del contenido de los votos incluídos en la elección. En los sistemas implementados en Estonia y Noruega, aunque parecen tener herramientas que incluyen estas pruebas de conocimiento nulo en todas las etapas del proceso, según algunos informes postelectorales\cite{carter2013}, esto no ocurría en la totalidad del proceso.
			Según estos mismos informes\cite{carter2013}, un ejemplo de sistema electoral por Internet E2E-verificable es Helios\ref{helios}, del que dicen que es un reconocido ``\textit{estándar en verificabilidad de voto por Internet}''. La visión de este sistema es que proporciona al proceso todas las garantías que aporta la verificabilidad E2E, como la capacidad de observar pruebas de conocimiento cero no interactivas que verifican que cada voto fue incluido correctamente y que el escrutinio completo fue computado con precisión. No obstante, hay que remarcar que, como su propio desarrollador indica, Helios es un sistema pensado en elecciones con bajo riesgo de coerción, lo cual no es válido para elecciones nacionales como el modelo estonio o noruego.
			
			Las garantías que ofrecen los esquemas de verificabilidad E2E eliminan la necesidad de los votantes de confiar tanto en los propios clientes (dispositivos, navegadores, sistemas operativos) que utilizan para votar, como los servidores y los trabajadores oficiales que administran los sistemas asociados a la recepción, descifrado y conteo de votos, que son los pilares críticos en los que se basa un sistema de voto por Internet.\notasCambio{Falta decir el porqué!! Porqué se olvidan los votantes de la amenaza? pues porque el E2E consigue que se demuestre la invariabilidad del voto emitido frente al contado...E2E}
				...
				\subsection{ADDER}\label{estadocuestion_adder}
					...
					\begin{enumerate}
						\item \textit{Autenticación de usuarios}. Para la autenticación de usuarios, \textsc{ADDER} emplea un sistema análogo a Kerberos que denominan \textit{gatekeeper} (guardián de la puerta). (...)
				...
				Threshold Encryption (+Secret Sharing)
...
%\notasDuda{TLS_RSA_WITH_DES_CBC_SHA}
				\end{description}
					...
					\subsection{Cifrado homomórfico}\label{primitivaCifradoHomomorfico}
						...
						\notasInfo[inline]{Hablamos del cifrado homomórfico}
					
						\subsubsection{ElGamal / ElGamal Exponencial}\label{primitivaCifradoHomomorfico_elgamal}
							
							Uno de los algortimos más utilizados para realizar un cifrado homomórfico es el de ElGamal.
							...
							La propiedad de ElGamal en cuanto a homomorfismo es muy interesante, pero de cara al voto por Internet, presenta ciertos problemas. El principal es que a operación en la que se basa es el producto. Sería mucho más útil que el homomorfismo fuera sobre la suma, ya que el escrutinio no es otra cosa que la suma (totalización) de votos.
						...
						\hline
							...
							\parbox[c]{\hsize}{
								\begin{itemize}[leftmargin=1em,font=$\bullet$]
									...
									\item Son susceptibles a ataques en donde votantes deshonestospueden enviar un mensaje que represente más de un voto para un candidato. 
								\end{itemize} 	
							}
							\\
						\hline
