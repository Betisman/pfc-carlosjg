...
%\notasDuda{TLS_RSA_WITH_DES_CBC_SHA}
	...
	\section{Estado actual de las tecnologías}
		...
		\subsection{NFC}\label{estadoNFC}
			...
			Ya en 2014, con la salida del DNIe 3.0, la tecnología NFC llegó a la identificación de los ciudadanos españoles. Esta nueva versión del carnet de identidad complementa el chip con contacto que incluía la primera versión del DNIe con un chip sin contacto que realiza las mismas funciones sin necesidad de un lector de chips del primer tipo.
