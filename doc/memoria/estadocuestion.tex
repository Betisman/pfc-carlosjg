...
los diálogos del sistema.
				...
				\subsubsection{Estudio holandés}\label{articuloEvaluacionVotoElectronicoHolandes}
			...
			Pese a que, dependiendo del autor, se pueden enumerar diferentes clasificaciones con los requisitos del voto electrónico, al final se observa que la mayoría de ellos son comunes a casi todas.
				...
				\begin{threeparttable}
					...
					\centering
						...
						\begin{tabularx}{\textwidth}{|m{.15\textwidth}|Y|Y|Y|Y|Y|Y|Y|}
							\hline
								\multirow{2}{*}{\textbf{Jurisdicción}} & \multicolumn{7}{c|}{\textbf{Razones para adopción del Voto por Internet}} \\
							\cline{2-8}
							...
							\hline
								Estonia	& $\bullet$ 	& $\bullet$ & $\bullet$ & & & & 	\\
							\hline
								Suiza	& $\bullet$ 	& $\bullet$ & $\bullet$ & $\bullet$ &  &  &  	\\
							\hline
								Noruega	& & & $\bullet$ & & & $\bullet$ & $\bullet$ 	\\
							\hline
								Edmonton	& & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & & \\
							\hline
								Markham	& $\bullet$ 	& $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & & 	\\
							\hline
								Halifax	& $\bullet$ 	& & $\bullet$ & & & & \\
							\hline
								Cape Breton	& $\bullet$ 	& $\bullet$ & $\bullet$ & & & & \\
							\hline
								Truro	& $\bullet$ 	& $\bullet$ & $\bullet$ & $\bullet$ & & $\bullet$ &  	\\
							\hline
								Grado de importancia & \scriptsize\specialcell{6/8\\75\%} & \scriptsize\specialcell{6/8\\75\%} & \scriptsize\specialcell{8/8\\100\%} & \scriptsize\specialcell{4/8\\50\%} & \scriptsize\specialcell{2/8\\25\%} & \scriptsize\specialcell{2/8\\25\%} & \scriptsize\specialcell{1/8\\12,5\%} \\
							\hline
						\end{tabularx}
						\begin{tablenotes}
							\scriptsize
						...
						\end{tablenotes}
						\label{tab:principalesRazonesVotoInternet}
						\caption{Principales razones para considerar la adopción del Voto por Internet}
					\end{threeparttable}
			\end{table}
...
%Desde el año 2005, Estonia se ha apoyado con éxito en Internet para realizar siete elecciones gubernamentales. Como evidencia del nivel de confianza pública en el sistema, en las elecciones al Parlamento Europeo ocurridas en mayo de este año el 33\% de todo el electorado estonio decidió emitir su voto en línea.
		...
		\section{Proyectos varios de voto por Internet }\label{estado_desarrollos}
			...
			No obstante, una vez que se decidió que el sistema debe cumplir con la característica de ser un sistema de votación auditable punto a punto (E2E Auditable Voting System), estos proyectos fueron descartados como códigos base de la adaptación al sistema a implementar para la EPS.
...
% *************************************************************************************************************** %				
		\section{Proyectos de Sistemas de Votación Auditables Punto a Punto - E2E Auditable Voting Systems}
			...
			Según estos mismos informes\cite{carter2013}, un ejemplo de sistema electoral por Internet E2E-verificable es Helios Voting (\ref{estadocuestion_helios}), del que dicen que es un reconocido ``\textit{estándar en verificabilidad de voto por Internet}''. Las bonanzas de este sistema es que proporciona al proceso todas las garantías que aporta la verificabilidad E2E, como la capacidad de observar pruebas de conocimiento cero no interactivas que verifican que cada voto fue incluido correctamente y que el escrutinio completo fue computado con precisión. No obstante, hay que remarcar que, como su propio desarrollador indica, Helios es un sistema pensado en elecciones con bajo riesgo de coerción, lo cual no es válido para elecciones nacionales como el modelo estonio o noruego.
...
para el certificado de la CA raíz.
		...
		Django es un framework para aplicaciones web escrito en Python. Además, tiene la caracterísitica de ser un framework gratuito y un proyecto open source.
\iffalse
