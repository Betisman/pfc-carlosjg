...
%future Helios releases being based upon Helios 4.0.
			...
			\subsection{Comparación Ágora - Helios}\label{comparativaAgoraVoting}
				En la tesis de Codina Lligoña \cite{Codina:tesis}, el autor realiza un estudio de diversos sistemas de votación, entre ellos Ágoa Voting (en su versión agora-ciudadana 2.0) y Helios 4.
