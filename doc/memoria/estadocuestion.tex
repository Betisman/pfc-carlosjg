				...
				\begin{threeparttable}
					...
					\centering
						...
						\begin{tabularx}{\textwidth}{|m{.15\textwidth}|Y|Y|Y|Y|Y|Y|Y|}
							...
							\cline{2-8}
								 & \tiny\textbf{Participación electoral} & \tiny\textbf{Liderazgo en Gobierno Electrónico} & \tiny\textbf{Accesibilidad} & \tiny\textbf{Conveniencia} & \tiny\textbf{Foco en servicio centrado en el ciudadano} & \tiny\textbf{Incrementar la participación de los jóvenes} & \tiny\textbf{Eficiencia en el escrutinio} \\
							\hline
							...
							\hline
								\raisebox{-1px}{\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{.2px}\fbox{\includegraphics[width=5mm,height=3mm]{imgs/Flag_of_Canada.png}}} \scriptsize{Cape Breton}	& $\bullet$ 	& $\bullet$ & $\bullet$ & & & & \\
							\hline
