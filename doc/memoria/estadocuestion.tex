...
\fi
		\section{Proyectos varios de voto por Internet }\label{estado_desarrollos}
			...
			\subsection{Civitas}\label{civitas}
				\todo[inline]{\url{http://www.cs.cornell.edu/projects/civitas/} Alternativa a Helios y Ágora.}
				\cite{conf/sp/ClarksonCM08}
...
para el certificado de la CA raíz.
		...
		\subsection{NFC}\label{estadoNFC}
			...
			\begin{figure}[htbp]
				\centering
					\includegraphics[width=0.30\textwidth]{imgs/rfid.jpg}
