...
\epigraphhead[70]{
	\epigraph{
		...
		\textit{
			Adolfo Suárez\footnotemark[\value{epihc}]
		}
	}
}
\footnotetext[\value{epihc}]{Del discurso de cierre de campaña [14/06/1977]}
\setcounter{footnote}{\value{epihc}}


\footnotetext[\value{epihc}]{Presidente del Gobierno de España (1976-1981) \url{https://es.wikipedia.org/wiki/Adolfo_Su\%C3\%A1rez}}
